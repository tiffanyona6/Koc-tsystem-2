                ...
                <div className="container-custom relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        ...
                        >
                            <ProjectCarousel
                                images={[
                                    { src: "/images/projects/targa-centro-salud-web-koc.webp", alt: "Targa KOC Centro de Salud" },
                                    { src: "/images/projects/proyecto-targa-web-koc.webp", alt: "Sistema Targa KOC" },
                                    { src: "/images/projects/targa-web-koc.webp", alt: "Targa KOC Instalación", objectPosition: "right center" }
                                ]}
