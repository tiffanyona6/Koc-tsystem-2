                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold text-gray-900 leading-tight font-montserrat tracking-tight mb-6">
                                Atemperado Automático <span className="text-primary">de Resina</span>
                            </h1>
                ...
                <div className="container-custom relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                            Contacte con KOC TECHNICAL SYSTEM para integrar esta tecnología en sus procesos de resina.
                        </p>
